    ...
    : QWidget(parent)
{
    ...
    patientService =
        new PatientService(this);

    connect(patientService,
            &PatientService::patientsLoaded,
            this,
            &PrescriptionWidget::handlePatientsLoaded);
    ...
    connect(diseaseService,
            &DiseaseService::diseasesLoaded,
            this,
            &PrescriptionWidget::handleDiseasesLoaded);
...
void PrescriptionWidget::savePrescription()
{
    ...
    model.patientId =
        patientBox->currentData().toInt();

    model.diseaseId =
        diseaseBox->currentData().toInt();
...
void PrescriptionWidget::handlePatientsLoaded(
...
void PrescriptionWidget::handleDiseasesLoaded(
